...
> [!info] Bronnen
> [HANDBOEK Het menselijk lichaam](https://drive.google.com/file/d/1Zdxc9eJ37zvJNRGCtAKaVxyCjUziDoAl/view?usp=drive_link)
...
> - [ ] De functie en onderdelen van de gewrichten
> - [ ] De beenderen, de spieren en de gewrichten
> - [ ] De opbouw, werking en het belang van het spijsverteringsstelsel
> - [ ] De bouw, werking en het belang van het urogenitaal stelsel
> - [ ] De bouw, werking en het belang van de inwendige klieren
...
## Waar ligt wat
---
**Anatomie** is de studie v/d bouw van ons lichaam. Terwijl **Fysiologie** de studie van de werking van de individuele stelsels en t.o.v. elkaar is; zie '[[#De vitale lichaamsstelsels]]' & '[[#De andere lichaamsstelsels]]'
...
- Links: ==linkerkant v/d PATIËNT== *(dus rechts voor jou)*
- Rechts: ==rechterkant v/d PATIËNT== *(dus links voor jou)*

#### Ledematen
Plaats t.o.v. de romp *(= torso)*: Bij armen en benen
- **Proximaal**: Dichter bij de romp
- **Distaal**: Verder weg v/d romp

Plaats t.o.v. de middenlijn van het lichaam: Ook voornamelijks bij armen en benen 
- **Mediaal**: Naar het midden toe
- **Lateraal**: Van het midden weg

#### Bekken
Plaats t.o.v. het bekken: 
- **Craniaal**/**Superieur**: Naar het hoofd toe vanuit de centrale *(x-)* as
- **Caudaal**/**Inferieur**: Naar de voeten/staart toe vanuit de centrale *(x-)* as 

#### Voor- en achterkant
Vertaling voor-en achterkant
- **Anterieur**/**Ventraal**: Voorkant, kant v/ buik
- **Posterieur**/**Dorsaal**: Achterkant, kant v/h rug
...
| Wervelkanaal *(holte)*                                                | Ruggenwervels, ruggemerg -> centraal zenuwstelsel                                                                                                                                                                                      |
| Borstholte                                                            | Linker en rechterlong *(in hun eigen pleuraholtes, zie [[Levensbedreigende aandoeningen]])*, het hart *(in hartzakje - pericardholte, zie [[#Hart- en bloedvatenstelsel]])*, luchtpijp, slokdarm en grote bloedvaten *(= mediastinum)* |
| Buikholte                                                             | Maag, lever, alvleesklier, milt, galblaas, darmen *(zie [[#De zones v/d buikregio]] & [[#Het spijsverteringsstelsel]])*                                                                                                                |
| Bekkenholte *(niet te kennen, deel van het grotere buik-bekkenholte)* | Blaas, einddarm en internvoortplantingsorganen *(zie [[#Het urogenitaal stelsel]])*                                                                                                                                                    |
...
| ------------------------------------------------------------------------ | ---------------------------------------- |
| Epigastrium *(= boven - maagregio)*                                      | Maag, lever, alvleesklier *(= pancreas)* |
| Mesogastrium/Umbilicaal *(= midden - maagregio)*                         | Dunne darm                               |
| Hypogastrium *(= onder - maagregio)*                                     | Blaas                                    |
| Rechter hypochonder *(= direct onder de ribben en achter het middenrif)* | Lever, galblaas                          |
| Linker hypochonder                                                       | Milt                                     |
| Rechter fossa *(= putje in bekkengebied)*                                | Appendix                                 |
| Linker fossa                                                             | Dikke darm                               |
| Rechter flank *(= flanken bekkengebied)*                                 | Nier                                     |
| Linker flank                                                             | Nier                                     |
### De wervelkolom
...
| --------------------------- | ------------------------------------ | ------------ | ------------------------------------------------------------------------------------------------------------------- |
| ==Halswervelzuil==          | 7 **cervicale** wervels              | C1 - C7      | Hebben holtes in pedikels waarin slagaders lopen                                                                    |
| ==Rugwervelzuil==           | 12 **thoracale**/**dorsale** wervels | D/T1 - D/T12 | Direct verbonden met ribben, zeer dunne ruggemergholte *(bij kleine verplaatsing al mogelijk verlammingssymptomen)* |
| ==Lendenwervelzuil==        | 5 **lumbale** wervels                | L1 - L5      | Heel dikke wervellichamen om onderrug te stabiliseren                                                               |
| ==Heiligbeen== *(= sacrum)* | 3-7, meestal 5 **sacrale** wervels   | s1 - s5/s7   | Samengegroeid                                                                                                       |
| ==Staartbeen== *(= cocyx)*  | 3-5 meestal 4 stuitwervels wervels   | Co1 - Co5/   | Totaal geen wervellichaam of bogen, enkel klein stuk bot                                                            |
- Tussen elke wervel zit een **tussenwervelschijf**: een rubber-achtige kraakbeenring met gel-achtige kern

## De vitale lichaamsstelsels
---
> https://dehulpdokter.nl/actueel/vitale-functies/

**Vitale lichaamsstelsels** zijn stelsels van levensbelang. Zonder of bij gebrek aan functioneren van deze stelsels is er een directe dreiging van levensgevaar. Ze betrekken:
- Het [[#Zenuwstelsel|zenuwstelsel]];
- Het [[#Ademhalingsstelsel|ademhalingsstelsel]];
- En het [[#Hart- en bloedvatenstelsel|hart- en bloedvatenstelsel]].
### Zenuwstelsel
Het zenuwstelsel stuurt alles aan *(= de centrale computer en haar bedrading)* als dit wegvalt zijn er geen signalen voor in te ademen, het hart correct te laten kloppen, ...

#### Hersenen *(& ruggenmerg)*
De hersenen zijn deel van het **centrale zenuwstelsel**, samen met het ruggenmerg. Zij wordt ook opgedeelt in 3 basisdelen:
- **Cerebrum** *(= groothersenen)*: Bewustzijn v/d omgeving en uitsturen van signalen *bv. iets opmerken -> erover praten*
- **Cerebellum** *(= kleine hersenen)*: Bewegingen coördineren *bv. wandelen, handen bewegen, ...*
- **Truncus cerebri** *(= hersenstam)*: Belangrijksste levensfuncties en verbinden van kleine- en grote hersenen met elkaar en het ruggenmerg
	- ==De hersenstam coördineert de hartslag, bewustzijn, ademhaling & de bloeddruk==. Is dus van gigantisch belang!
...
Een zenuwbaan bevat duizende kleinere zenuwbaantjes met verschillende doelen die enkel in één richting kunnen lopen *(van of naar de hersenen)*
...
#### On- & willekeurig zenuwstelsel
- Willekeurig: Alles dat je bewust doet, *bv. praten, verplaatsen ledematen, voelen, ...*
	- ==Filter==: Om onnodige hersenprikkels te ontvangen zullen de hersenen na een tijdje stimulantie gewoon worden. *bv. een ring rond de vinger*
- Onwillekeurig *(= autonome zenuwstelsel)*:  maag & darmstelsel, klieren, controle v/h hart 

#### Fight-or flight
Vluchten of vechten wordt bepaalt door het para- en orthasympatisch deel v/h autonoom *(onwillekeurig)* zenuwstelsel. 
- **Parasympatisch**: opslaan en conserveren van energie -> op 't gemakje *(= para - paralyse)*
- **Orthosympatisch**: hartslag omhoog, vasoconstrictie, meer zuurstof opslaan, glucose loslaten, ... *(= ortho - bewegen)*


>[!important] Belang voor de Hulpverlener-Ambulancier
> - ==De gekende 0-4-10 minuten regel== waar na 4 minuten hersenschade optreed en na 10 minuten de eerste hersencellen ==onomkeerbaar== afsterven *(hersendood)*
> - ==Wervelschade==: drukken op het ruggenmerg en geven *(mogelijk onomkeerbare)* verlammingsverschijnselen

### Ademhalingsstelsel
Het ademhalingsstelsel zorgt voor het toevoeren van zuurstofmoleculen en afvoeren van koolstofdioxide.
...
2. Keelholte: Verbinding van mond- en neus
	- Pas op: ==bij zeer jonge baby's ademen enkel via de neus== *(weten nog niet dat ze kunnen ademen via de mond)* bij een obstructie is dit dus van levensgevaar 
3. **Larynx** *(= strottehoofd):* verbinding tussen keelholte en luchtpijp
	- **Glottis**: Onderdeel v/d larynx waar stembanden zich bevinden
	- **Epiglottis** *(= strotklepje)*: Sluitklep om slokdarm en luchtpijp te scheiden
4. **Trachea** *(= luchtpijp)*: gemaakt uit halve kraakbeen ringen *(om grote brokken voedsel door te laten)* 
5. **Bronchiën** *(= luchtpijptakken)*: Vertakken de luchtpijp in kleinere delen
	- **Bronchiolen** *(= kleinere luchtpijptakken)*: Vertakken nog verder naar de alveolen toe
6. **Alveolen** *(= longblaasjes)*: Kleine zakjes die zuurstofwisseling doen met het bloed

#### Werking v/h ademhalingsstelsel
...
- Indien deze vliezen doorbroken worden kan een long niet correct opblazen. De lucht hoopt op in de borstkas of ontsnapt via doorbroken longzak *(indien er een gat naar buiten aanwezig is en de grootte)*
	- **Pneumothorax** *(= klaplong)*: longperforatie naar de buitenwereld,
	- **Spanningspneumothorax**: longperforatie naar de pleuraholte *(komt lucht bij in de zak maar gaat niet weer weg - druk verhoogt en longzak begint de drukken op hart)*

>[!important] Belang voor de Hulpverlener-Ambulancier
> - Onvoldoende/geen zuurstof zorgt voor hersenschade *(zie vorige 0-4-6 principe)*
> - Belemmering van de luchtweg *door bv. tong, braaksel, voorwerp, ...* is ook direct levensbedreigend - ==Airway==
> - Gebrokken ribben of externe voorwerpen die de longvliezen doorbreken die blaasbalgfunctie v/d longen belemmert

### Hart- en bloedvatenstelsel

#### Onderdelen v/h hart- en bloedvatenstelsel
> Bijlagen uit het boek
...
3 soorten aders:
- **Ader** *('= venen)*: Vervoert zuurstofarm bloed terug naar hart voor oxygenatie d.m.v. de longen
	- Zit minder druk op en hebben dus kleppen *(om de zwaartekracht tegen te gaan)*
- **Slagader** *(= arteriën)*: Vervoert zuurstofrijk bloed van het hart weg naar organen
- **Haarvaten**: Vertakkingen v/d aderen die zodanig klein worden dat ze poriën kunne hebben voor gasuitwisseling *(zuurstof en koolstofdioxide)*

Speciale aders:
- **Holle ader**: 2 aders die zuurstofarm bloed naar het hart brengen, de bovenste van het bovenste gedeelte v/h lichaam, onderste van onderste
- **Longslagader**: Pompt zuurstofarm bloed naar de longen *(ader = van het hart weg)*
...
1. Zuurstofarm bloed komt binnen in het **rechter atrium** *(= rechtervoorkamer)* (1) via de holle aders (3 & 11)
2. Het bloed wordt gepompt naar het rechter ventrikel *(= rechterkamer)* (10)
	- Dit gebeurt via de eerste hartklep, de **Tricuspid-klep** *(= driekleppige klep)* (12)
3. Vanuit het **rechter ventrikel** pompt het bloed naar de longen om te oxygeneren via de longslagader (5)
	- Dit gebeurt via de tweede hartklep, de **Pulmonaire-klep** (13) *(pulmonair = alles betrekkende longen)* 
4. Het zuurstofrijk bloed komt vanuit de longen terug via de longaders (6) naar het **linker atrium** *(= linkervoorkamer)*
5. Het bloed wordt gepompt naar het **linker ventrikel** *(= linkerkamer)* (2)
	- Dit gebeurt via de derde hartklep, de **Mitralisklep** *(= tweekleppig klep)* (7)
6. Het zuurstofrijk bloed wordt naar de rest van het lichaam gepompt via de aorta (4) 
...
- **Rode bloedcellen**: bevatten hemoglobine *(= eiwit + ijzermolecule)* om zuurstof te dragen
	- *(5.000.000/mm3)*
- **Witte bloedcellen**: bevatten alle immuniteitscellen 
	- *(±10.000/mm3)*
- **Bloedplaatjes**: Afgebroken bloedcellen v/h beenmerg die niks vormen maar wel helpen bij de stolling
	- *(150.000 - 300.000/mm3.)*

#### Plaatsen om polsslag te meten
1. Op het hart zelf 
2. Aan de hartslagader *(= carotis)*
3. Aan de bovenarm onder de oksel *(= arteria brachialis)*
4. Aan de bicep *(= arteria brachialis)*
5. Aan de pols *(= arteria radialis)*
6. Aan de lies *(= arteria femoralis)*
7. Aan de enkel *(= arteria tibialis posterior)*
8. Aan de voetrug *(= arteria dorsalis pedis)*
9. Onder de knie *(= arteria poplitea)*

#### Mogelijke problemen
##### 1. Hartzakje
Het hart zit in de pericard *(= hartzakje)* met vanboven een opening voor de grote bloedvaten
